...
A web-based AI agent copilot. 10 specialized agents (Zara, Kofi, Amara, Idris, Nala, Tariq, Sana, Ravi, Luna, Omar) answer business questions across revenue, operations, customers, inventory, marketing, finance, data, tech, growth, and partnerships. Multi-provider LLM support — bring your own key (OpenRouter, Google, OpenAI, Anthropic, Ollama, custom).
