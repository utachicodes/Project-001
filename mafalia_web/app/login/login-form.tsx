        ...
        >
          ...
          <p className={`${fustat.className} text-[18px] tracking-[-0.4px] text-[#505050] mb-8 text-center`}>
            {mode === "signup" 
              ...
              : mode === "forgot"
              ? (lang === "en" ? "Enter your email to receive a reset link." : lang === "fr" ? "Entrez votre e-mail pour recevoir un lien." : "أدخل بريدك الإلكتروني لتلقي رابط إعادة التعيين.")
              : t.signInOrchestrate
            }
          </p>
            ...
            {success ? (
              ...
              >
                ...
                <p className="text-[14px] text-gray-300 leading-relaxed mb-6">
                  {mode === "forgot" ? t.checkEmailReset : (lang === "en" ? "We sent a confirmation link to " : lang === "fr" ? "Nous avons envoyé un lien de confirmation à " : "لقد أرسلنا رابط تأكيد إلى ")}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {mode !== "forgot" && (
                  <div className="space-y-1.5">
                    <div className="flex justify-between items-center px-1">
                      <label htmlFor="password" className="text-[13px] font-medium text-gray-200">
                        {t.password}
                      </label>
                      {mode === "login" && (
                        <button
                ...
                >
                  {loading ? (
                    ...
                    <>
                      {mode === "signup" ? t.signUp : mode === "forgot" ? t.sendResetLink : t.logInSecurely}
                ...
                <div className="pt-2 text-center">
                  {mode === "forgot" ? (
                    <button
                      ...
                      className="text-[13px] font-medium text-gray-200 hover:text-white transition-colors underline"
                    >
                      {t.backToLogin}
                    </button>
                  ) : (
