        ...
        <>
          ...
          >
            <div className="rounded-2xl overflow-hidden shadow-2xl"
                 style={{ background: 'rgba(8,12,20,0.98)', border: '1px solid rgba(124,58,237,0.25)', backdropFilter: 'blur(24px)' }}>

              {/* Top glow stripe */}
              <div className="h-px" style={{ background: 'linear-gradient(90deg, transparent, rgba(124,58,237,0.6), rgba(0,212,255,0.4), transparent)' }} />
              ...
              <div className="flex items-center gap-3 px-4 py-3.5" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <input
                  ...
                  className="flex-1 bg-transparent text-slate-100 placeholder-slate-600 text-[14px] outline-none"
                  autoComplete="off"
                  spellCheck={false}
                        ...
                        return (
                          ...
                          >
                            <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
                                 style={{ background: `${cmd.color}18`, border: `1px solid ${cmd.color}28` }}>
                              <Icon size={14} style={{ color: cmd.color }} />
                            </div>
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2">
                                <span className="text-[13.5px] font-medium text-slate-200">{cmd.label}</span>
                                <span className="text-[10px] font-mono text-slate-600">{cmd.id}</span>
                              </div>
                              <p className="text-[12px] text-slate-500 truncate mt-0.5">{cmd.description}</p>
                            </div>
                            {isSelected && <ArrowRight size={13} className="text-slate-600 flex-shrink-0" />}
                          </button>
                        )
                      })}
                    </div>
